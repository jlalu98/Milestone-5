            ...
            >
                ...
                <Modal.Body>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="author" placeholder="Author" value={author} onChange={handleAuthorChange}/>
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="rating" placeholder="Rating" value={rating} onChange={handleRatingChange}/>
                    </div>
                        <div className="mb-3">
...
<textarea className="form-control" id="description" rows={3} value={description} onChange={handleDescriptionChange}></textarea>
                        ...
                        <div className="mb-3">
                        <label htmlFor="exampleFormControlInput1" className="form-label">Cover</label>
                        <input type="text" className="form-control" id="cover" placeholder="Cover image" value={cover} onChange={handleCoverChange}/>
                    </div>
                    </Modal.Body>
                <Modal.Footer>
