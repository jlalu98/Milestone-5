   ...
   // const [book,setBook]=useState(state.book_detail);
    ...
    <div className="container d-flex justify-content-center">
        <div className="card p-2">
            ...
            <div className="buttons d-flex flex-row gap-3 px-3"> <button type="button" className="btn btn-dark w-100" onClick={()=>{deleteBook(dispatch,state.book_detail._id);history.push("/")}}>Delete</button> <button className="btn btn-outline-dark w-100">Edit</button> </div>
        </div>
    </div>
</div>
        </>
